...
class TrackingLinkControllerTests {
    ...
    void listDetailsReturnsOk() throws Exception {
        TrackingLinkDetailDataDto detail = new TrackingLinkDetailDataDto();
        when(service.getTrackingLinkDetails(any())).thenReturn(
                new TrackingLinkPageOutputDto(1, Collections.singletonList(new TrackingLinkDetailOutputDto("1", detail))));
